...
const FloatingConsultButton = () => {
  ...
  return (
    <button
      onClick={openModal}
      className="fixed right-6 bottom-24 z-50 group !shadow-none !filter-none appearance-none bg-transparent border-0 p-0"
    ...
    >
      ...
      {/* Button */}
      <div className="w-14 h-14 bg-gradient-to-br from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 rounded-full flex items-center justify-center transition-colors duration-200 !shadow-none !filter-none ring-0">

            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-white">
                ...
                <p className="text-white/90">
                  Get a consultation with our expert lawyers
                </p>
              </div>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-lg shadow-gold-500/20 border border-gold-200">
                  <img
                    src={logoImage}
                    alt="Prima Lexus Logo"
                    className="w-10 h-10 object-contain"
                  />
                </div>
                <div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-white to-gold-300 bg-clip-text text-transparent">
                    Prima Lexus
                  </h3>
              ...
              <p className="text-olive-300 leading-relaxed mb-8">
                A foremost full service law firm providing legal assistance and
                solutions across India with expertise in all areas of practice.
              ...
              <ul className="space-y-5">
                  ...
                  >
                    ...
                    <div className="text-olive-300 group-hover:text-gold-400 transition-colors">
                      ...
                      {primaryContact.phone[1] && (
                        <p className="text-sm">{primaryContact.phone[1]}</p>
                      )}
                    </div>
                  </a>
                </li>
                <li>
                  ...
                  >
                    ...
                    <p className="text-olive-300 group-hover:text-gold-400 transition-colors">
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
              <p className="text-olive-400">
                © {currentYear}{" "}
                <span className="text-gold-400 font-medium">Prima Lexus</span>.
                All rights reserved.
              </p>

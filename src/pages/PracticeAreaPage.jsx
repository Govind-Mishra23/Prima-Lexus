...
const PracticeAreaPage = () => {
  ...
  const pageUrl = `https://primalexus.com/practice-areas/${practiceArea.slug}`;
  ...
  return (
    <main>
      <SEO
        ...
        description={practiceArea.description}
        keywords={`${practiceArea.title.toLowerCase()}, legal services delhi ncr, prima lexus`}
        url={pageUrl}
        type="article"
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-12">
                <h3 className="text-xl font-bold text-olive-800 mb-6">
                  Why Choose Prima Lexus for {practiceArea.title}?
                </h3>
                <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="mt-6 pt-6 border-t border-olive-200">
                  <div className="bg-gradient-to-br from-olive-800 to-olive-900 rounded-xl p-5 text-white">
                    ...
                    <p className="text-olive-300 text-sm mb-4">
                      Call us 24/7 for legal support
                    </p>
      ...
      <section className="py-16 bg-gradient-to-r from-gold-500 to-gold-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Our experienced {practiceArea.title.toLowerCase()} lawyers are ready
            to help you. Schedule a consultation today.
          </p>

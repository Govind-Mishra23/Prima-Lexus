...
import { FaCheckCircle, FaArrowRight, FaPhone, FaEnvelope } from 'react-icons/fa';
        ...
        return (
            <main className="min-h-screen flex items-center justify-center bg-olive-50">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-olive-800 mb-4">Service Not Found</h1>
                    <p className="text-olive-600 mb-8">The service you're looking for doesn't exist.</p>
    ...
    return (
        <main>
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="flex items-start gap-6 mb-10">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold text-olive-800 mb-3">{service.title}</h2>
                                    <p className="text-olive-600 leading-relaxed">{service.description}</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-12 bg-olive-50 rounded-2xl p-8">
                                <h3 className="text-xl font-bold text-olive-800 mb-6">Our {service.title} Services</h3>
                            ...
                            {/* Why Choose Us */}
                            <div className="mt-12">
                                <h3 className="text-xl font-bold text-olive-800 mb-6">Why Choose Prima Lexus?</h3>
                                <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <div className="bg-white border border-olive-200 rounded-2xl p-6 shadow-lg sticky top-24">
                                ...
                                <div className="mt-6 pt-6 border-t border-olive-200">
                                    <p className="text-sm text-olive-600 mb-4">Or contact us directly:</p>
                                    <div className="space-y-3">
                                        <a
                                            href={`tel:${primaryContact.phone[0].replace(/[^0-9+]/g, '')}`}
                                            className="flex items-center gap-3 text-olive-700 hover:text-gold-600 transition-colors"
                                        >
            ...
            <section className="py-16 bg-olive-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-2xl font-bold text-olive-800 mb-8 text-center">Explore Our Other Services</h2>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="w-12 h-12 bg-gradient-to-br from-olive-700 to-olive-800 rounded-lg flex items-center justify-center mb-4 group-hover:from-gold-500 group-hover:to-gold-600 transition-all">
                                            <SIcon className="w-6 h-6 text-gold-400 group-hover:text-white transition-colors" />
                                        </div>
                                        <h3 className="font-bold text-olive-800 mb-2">{s.title}</h3>
                                        <p className="text-sm text-olive-600 line-clamp-2">{s.description}</p>
                                    </Link>
                                );
                            })}
                    </div>
            ...
            <section className="py-16 bg-gradient-to-r from-gold-500 to-gold-600">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-white/90 mb-8 max-w-2xl mx-auto">
                        Our experienced team is ready to help you with your {service.title.toLowerCase()} matters.

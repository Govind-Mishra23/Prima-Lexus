...
const ServicePage = () => {
  ...
  const pageUrl = `https://primalexus.com/services/${service.slug}`;
  const serviceSchema = {
  ...
  return (
    <main>
      <SEO
        title={service.title}
        description={service.description}
        keywords={`${service.title.toLowerCase()}, law firm delhi ncr, legal consultation, prima lexus`}
        url={pageUrl}
        type="article"
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-12 bg-olive-50 rounded-2xl p-8">
                <h3 className="text-xl font-bold text-olive-800 mb-6">
              ...
              <div className="mt-12">
                <h3 className="text-xl font-bold text-olive-800 mb-6">
                  Why Choose Prima Lexus?
                </h3>
                <div className="grid sm:grid-cols-2 gap-4">
                  {service.whyChooseUs.map((item, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-3 bg-white border border-olive-200 rounded-xl p-4 hover:border-gold-400 transition-colors"
                    >
      ...
      <section className="py-16 bg-olive-50">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-olive-800 mb-8 text-center">
      ...
      <section className="py-16 bg-gradient-to-r from-gold-500 to-gold-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Our experienced team is ready to help you with your{" "}
            {service.title.toLowerCase()} matters. Schedule a consultation
            today.
          </p>

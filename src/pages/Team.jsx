        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-olive-200">
              Meet our experienced team of advocates and legal consultants
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              {/* Content */}
              <div>
                <span className="inline-block text-gold-600 font-semibold mb-4">
                  Founder & Lead Advocate
                </span>
                <h2 className="text-3xl md:text-4xl font-bold text-olive-800 mb-2">
                  Advocate A K Tiwari
                </h2>
                <p className="text-gold-600 text-xl mb-1">
                ...
                <div className="relative mb-8 bg-olive-50 rounded-xl p-6 border-l-4 border-gold-500">
                  ...
                  <div className="pl-6">
                    <p className="text-olive-700 text-lg leading-relaxed italic">
                      In a civilized society, law aims to maintain social order,
                      protect rights of individuals and promote justice. We as
                      Advocates in India, play a pivotal role in the country's
                      Legal system, serving as a backbone of justice and Legal
                      integrity.
                    </p>
                ...
                <div>
                  <p className="text-olive-500 text-sm mb-3">
                    Areas of Expertise
                  </p>
